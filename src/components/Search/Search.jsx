    ...
    return (
        <div className={styles.root}>
            <svg
                ...
                x="0px"
                y="0px"
                viewBox="0 0 442.013 442.013"
                style={{ enableBackground: "new 0 0 442.013 442.013" }}
            >
                <g>
                    <g>
                        <g>
                            <path
                                d="M161.586,39.608c-67.287,0-122.027,54.736-122.027,122.02c0,32.597,12.691,63.242,35.734,86.289
				...
				c58.815,0,106.667,47.848,106.667,106.663C268.253,190.119,257.159,216.907,237.007,237.053z"
                            />
                            <path
                                d="M427.747,359.09l-96.208-96.208l-15.858,15.858l-22.835-22.828c46.008-63.877,39.209-152.378-16.975-208.568
				...
				c6.274,6.281,9.735,14.619,9.735,23.501C426.624,402.319,423.167,410.665,416.893,416.939z"
                            />
                            <path
                                d="M391.624,395.22l-21.668-21.675l-10.865,10.861l21.675,21.682c4.553,4.547,9.865,5.226,12.626,5.226
				c2.765,0,8.079-0.679,12.64-5.24l-10.861-10.861C394.194,396.192,392.59,396.186,391.624,395.22z"
                            />
                            <path
                                d="M100.668,100.717c-16.295,16.299-25.269,37.932-25.269,60.921h15.36c0-18.886,7.376-36.663,20.774-50.057
